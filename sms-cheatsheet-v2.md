...
```
hey — Sean has a few discovery call spots open this week if you want to talk through your package 💛 book.flyiniris.com/widget/booking/V3H7cSaX3iSNqMlRA8O8
```
...
```
ready whenever you are — book.flyiniris.com/widget/booking/V3H7cSaX3iSNqMlRA8O8 💛
```
